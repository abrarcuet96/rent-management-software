...
export const expenseUpdateSchema = z.object({
  ...
  amount: z.coerce.number().min(0.01, "পরিমাণ প্রয়োজন").optional(),
  expense_date: z.string().min(1, "তারিখ প্রয়োজন").optional(),
  is_tenant_charged: z.boolean().optional(),
});

export type CREATE_EXPENSE_CATEGORY = z.infer<typeof expenseCategorySchema>;
export type CREATE_EXPENSE = z.infer<typeof expenseSchema>;
export type UPDATE_EXPENSE = z.infer<typeof expenseUpdateSchema>;
